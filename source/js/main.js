...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const itemSpeedEl = document.querySelector(
    ".options-item.options-item--speed"
  );
  const itemCaptionsEl = document.querySelector(
    ".options-item.options-item--captions"
  );
  ...
  speedListItem.forEach((item) => {
    item.addEventListener("click", () => {
      const activeSpeedListItem = document.querySelector(
        ".options-speed-item--active"
      );
  ...
  captionsListItem.forEach((item) => {
    item.addEventListener("click", () => {
      const activeCaptionListItem = document.querySelector(
        ".options-captions-item--active"
      );
